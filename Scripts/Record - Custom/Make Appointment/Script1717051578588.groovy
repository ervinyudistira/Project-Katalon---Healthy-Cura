...
WebUI.click(findTestObject('Inspect/menu_login'))

WebUI.takeScreenshot()

WebUI.setText(findTestObject('Inspect/input_password'), GlobalVariable.Username)

WebUI.setText(findTestObject('Inspect/input_password'), GlobalVariable.Password)

WebUI.takeScreenshot()

WebUI.click(findTestObject('Inspect/button_login'))
